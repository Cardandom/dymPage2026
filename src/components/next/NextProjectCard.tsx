  ...
  return (
    ...
    >
      <Link
        ...
        className="block rounded-[2.5rem] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-neon focus-visible:ring-offset-4 focus-visible:ring-offset-white"
      >
        ...
        <div className="flex justify-between items-start gap-6">
          ...
          <div
            aria-hidden="true"
            className="w-12 h-12 rounded-full border border-slate-200 bg-white flex flex-none items-center justify-center group-hover:border-brand-neon group-hover:bg-brand-neon transition-all shadow-sm"
          >
